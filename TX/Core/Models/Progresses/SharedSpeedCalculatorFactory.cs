...
namespace TX.Core.Models.Progresses
{
    ...
    public abstract class SpeedCalculator
    {
        ...
        /// <summary>
        /// Totally running time of the speed calculator.
        /// </summary>
        public TimeSpan RunningTime => GetRunningTime();

        protected abstract TimeSpan GetRunningTime();
    ...
    public static class SharedSpeedCalculatorFactory
    {
        ...
        private class InnerSpeedCalculator : SpeedCalculator
        {
            ...
            protected override TimeSpan GetRunningTime() =>
                UpdateInterval * Time;
        }
